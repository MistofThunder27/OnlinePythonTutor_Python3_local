(function () {
    ...
    var q = function (A) {
        ...
        var G = function (aR) {
            ...
            var aM = function (aS, aX, aT, aV, aU, aW) {
                if (aS) {
                    ...
                    var a3 = aT.endpoints[aX] || aT.endpoint || D.Defaults.Endpoints[aX] || i.Defaults.Endpoints[aX] || D.Defaults.Endpoint || i.Defaults.Endpoint;
                    ...
                    var a1 = aT.endpointStyles[aX] || aT.endpointStyle || D.Defaults.EndpointStyles[aX] || i.Defaults.EndpointStyles[aX] || D.Defaults.EndpointStyle || i.Defaults.EndpointStyle;
                    ...
                    var a0 = aT.endpointHoverStyles[aX] || aT.endpointHoverStyle || D.Defaults.EndpointHoverStyles[aX] || i.Defaults.EndpointHoverStyles[aX] || D.Defaults.EndpointHoverStyle || i.Defaults.EndpointHoverStyle;
                    if (aW != null) {
                        if (a0 == null) {
                            a0 = {}
                        }
            ...
            this.paint = function (aV) {
                ...
                var aZ = this.connector.compute(a1, aY, this.endpoints[a7].anchor, this.endpoints[a3].anchor, aG.paintStyleInUse.lineWidth, a6);
        ...
        var aq = function (aY) {
            ...
            this.setHoverPaintStyle(aY.hoverPaintStyle || D.Defaults.EndpointHoverStyle || i.Defaults.EndpointHoverStyle, true);
            this.paintStyleInUse = this.paintStyle;
...
(function () {
    ...
    jsPlumb.Overlays.Label = function (e) {
        ...
        var g = e._jsPlumb.overlayClass + " " + (l.labelStyle.cssClass ? l.labelStyle.cssClass : e.cssClass ? e.cssClass : "");
        b.className = g;
