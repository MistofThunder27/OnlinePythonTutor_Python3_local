...
(function (a, b) {
  ...
  function bY(a, c, d, e, f, g) {
    ...
    for (; i < j && (k || !l); i++)
      (l = h[i](c, d, e)),
        typeof l == "string" && (!k || g[l] ? (l = b) : (c.dataTypes.unshift(l), (l = bY(a, c, d, e, l, g))));
        ...
        select: {
          get: function (a) {
            ...
            for (var g = e ? b : 0, h = e ? b + 1 : d.length; g < h; g++) {
              ...
              if (
                i.selected &&
                (f.support.optDisabled ? !i.disabled : i.getAttribute("disabled") === null) &&
                (!i.parentNode.disabled || !f.nodeName(i.parentNode, "optgroup"))
              ) {
                value = f(i).val();
                if (e) return value;
                c.push(value);
      ...
      var l = (k.selectors = {
          ...
          filter: {
            PSEUDO: function (a, b, c, d) {
              ...
              if (e === "contains") return (a.textContent || a.textContent || k.getText([a]) || "").indexOf(b[3]) >= 0;
              if (e === "not") {
                var g = b[3];
    ...
    f.ajaxPrefilter("json jsonp", function (b, c, d) {
      ...
      if (b.dataTypes[0] === "jsonp" || (b.jsonp !== !1 && (cb.test(b.url) || (e && cb.test(b.data))))) {
        ...
        b.jsonp !== !1 &&
          ((j = j.replace(cb, l)),
          b.url === j &&
            (e && (k = k.replace(cb, l)), b.data === k && (j += (/\?/.test(j) ? "&" : "?") + b.jsonp + "=" + h))),
          (b.url = j),
          (b.data = k),
          (a[h] = function (a) {
            g = [a];
            ...
            send: function (e, g) {
              ...
              h.send((c.hasContent && c.data) || null),
                ...
                !c.async || h.readyState === 4
                  ? d()
                  : ((i = ++cd), cc && (ce || ((ce = {}), f(a).unload(cc)), (ce[i] = d)), (h.onreadystatechange = d));
            },
            abort: function () {
              d && d(0, 1);
            },
          ...
          (c = j ? j.getComputedStyle(b, null) : b.currentStyle),
            ...
            b === d &&
              ...
              f.offset.doesNotAddBorder &&
                (!f.offset.doesAddBorderForTableAndCells || !cu.test(b.nodeName)) &&
